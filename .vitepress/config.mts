      ...
      '/report/': [
        { text: 'Report overview', link: '/report/' },
        {
          ...
          items: [
            ...
            { text: '9. Exercises and Practice', link: '/report/07a-exercises' },
            { text: '10. Adopting the Shift', link: '/report/08-adopting-the-shift' },
            { text: '11. Assumptions & Follow-Up', link: '/report/09-assumptions-follow-up' },
            { text: '12. References', link: '/report/10-references' },
          ],
        },
      ],
    },
