  ...
  themeConfig: {
    ...
    sidebar: {
      '/reports/': [
        ...
        { text: 'EDI Repository Portfolio Analysis', link: '/reports/edi-repos-analysis/' },
      ],
      ...
      '/reports/edi-repos-analysis/': [
        { text: 'Report overview', link: '/reports/edi-repos-analysis/' },
        {
          text: 'Sections',
          items: [
            { text: '1. Executive summary', link: '/reports/edi-repos-analysis/01-executive-summary' },
            { text: '2. Portfolio overview', link: '/reports/edi-repos-analysis/02-portfolio-overview' },
            { text: '3. AI enablement boilerplates', link: '/reports/edi-repos-analysis/03-ai-enablement-boilerplates' },
            { text: '4. Secure SDLC and governance', link: '/reports/edi-repos-analysis/04-secure-sdlc-governance' },
            { text: '5. Academy and LMS', link: '/reports/edi-repos-analysis/05-academy-lms' },
            { text: '6. DSO internal tooling', link: '/reports/edi-repos-analysis/06-dso-internal-tooling' },
            { text: '7. MSDP data platform', link: '/reports/edi-repos-analysis/07-msdp-data-platform' },
            { text: '8. Client delivery and production', link: '/reports/edi-repos-analysis/08-client-delivery-production' },
            { text: '9. QA and testing', link: '/reports/edi-repos-analysis/09-qa-testing' },
            { text: '10. Front-end and infrastructure', link: '/reports/edi-repos-analysis/10-frontend-and-infra' },
            { text: '11. Patterns and maturity', link: '/reports/edi-repos-analysis/11-patterns-and-maturity' },
            { text: '12. WordPress recommendations', link: '/reports/edi-repos-analysis/12-wp-recommendations' },
          ],
        },
      ],
    },
