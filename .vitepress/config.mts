      ...
      '/report/': [
        { text: 'Report overview', link: '/report/' },
        {
          ...
          items: [
            ...
            { text: '5. Consultancy Environment', link: '/report/05-consultancy-environment' },
            { text: '6. Scenario-Based Development', link: '/report/06-scenario-based-development' },
            { text: '7. Creating Specifications', link: '/report/07-creating-specifications' },
            { text: '8. Spec Structure & Examples', link: '/report/08-spec-structure-examples' },
            { text: '9. Exercises and Practice', link: '/report/09-exercises-and-practice' },
            { text: '10. Adopting the Shift', link: '/report/10-adopting-the-shift' },
            { text: '11. Assumptions & Follow-Up', link: '/report/11-assumptions-follow-up' },
            { text: '12. References', link: '/report/12-references' },
          ],
        },
      ],
    },
