---
title: AI-Augmented Development Pipelines (Reconciled)
...
Each section is available as its own page; use the sidebar to navigate.

| Section | Description |
|--------|-------------|
| [1. Overview](/reports/ai-augmented-dev-pipeline/01-overview) | Problem context, architecture, tooling, guardrails, KPIs, next steps |
| [2. PR Review (AI-Augmented)](/reports/ai-augmented-dev-pipeline/02-pr-review) | First-pass PR review with Bionic — diff-only, no merge rights |
| [3. Refactoring (AI-Assisted)](/reports/ai-augmented-dev-pipeline/03-refactoring) | Rector in CI, Cursor locally — PHP 8.x and WP/Laravel refactors |
...
**Related research:** Automated PII enforcement for this pilot is tracked separately in [PII Gateway for Dev AI](/reports/pii-gateway/) (assumptions and positioning in progress).
