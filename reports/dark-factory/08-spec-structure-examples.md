...
To build fluency, the report includes **[Exercises and Practice](/reports/dark-factory/09-exercises-and-practice)** (Section 9): hands-on exercises for writing specs, plans, tasks and holdout scenarios, plus a spec-delta review exercise. They use WordPress- and Laravel-friendly examples and can be run in 15–90 minutes each.
