...
- OpenSpec — [openspec.dev](https://openspec.dev): lightweight spec-driven framework; specs in repo by capability; proposal, design, tasks and spec deltas for reviewing intent before code; native support for Cursor, Claude Code, Copilot and others; brownfield-first, open source.
